...
namespace muhasebe
{
    public partial class Form5 : Form
    {
        ...
        private void kDVLeriGörüntüleToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void Form5_Load(object sender, EventArgs e)
        {
            ...
            // TODO: This line of code loads data into the 'muhasebeortakhesaplarDataSet1.fisler' table. You can move, or remove it, as needed.
            this.fislerTableAdapter.Fill(this.muhasebeortakhesaplarDataSet1.fisler);
        ...
        private void kaydetToolStripMenuItem_Click(object sender, EventArgs e)
        {
            /*if (eskifislerekaydet.Checked)
            {
                ...
                try
                {
                    ...
                    string komut = "INSERT INTO eskifisler(FisTarihi,FisTipi,FisNo,EvrakNo,BorcToplami,AlacakToplami,Bakiye,Aciklama)VALUES('" + fistarihi.Text + "','"+"Tahsil Fişi"+ "','" + fisno.Text + "','" + evrakno.Text + "','" + borctoplami.Text + "','" + alacaktoplami.Text + "','" + bakiyetoplami.Text + "','" + col6 + "')";
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        try
                        {
                            ...
                            string komut = "INSERT INTO tahsilfisi(FisTarihi,FisNo,EvrakNo,MaddeNo,HesapKodu,FirmaKodu,StokKodu)VALUES('" + fistarihi.Text + "','" + fisno.Text + "','" + evrakno.Text + "','" + "1" + "','" + hesapkodu.Text + "','" + "2" + "','" + "3" + "')";
