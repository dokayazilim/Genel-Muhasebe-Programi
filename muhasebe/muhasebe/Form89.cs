...
namespace muhasebe
{
    public partial class Form89 : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'muhasebeDataSet7.hesapkodlari' table. You can move, or remove it, as needed.
            this.hesapkodlariTableAdapter4.Fill(this.muhasebeDataSet7.hesapkodlari);
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            frm2.devredenkdvhesapkodu.Text = dataGridView1.Rows[e.RowIndex].Cells[0].Value.ToString();
            this.Hide();
        }
    }
}
