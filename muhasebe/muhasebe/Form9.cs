...
namespace muhasebe
{
    public partial class Form9 : Form
    {
        ...
        private void Form9_Load(object sender, EventArgs e)
        {
            ...
            // TODO: This line of code loads data into the 'muhasebeortakhesaplarDataSet5.fisler' table. You can move, or remove it, as needed.
            this.fislerTableAdapter.Fill(this.muhasebeortakhesaplarDataSet5.fisler);
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        try
                        {
                            ...
                            string komut = "INSERT INTO kapanisfisi(FisTarihi,FisNo,EvrakNo,MaddeNo,HesapKodu,FirmaKodu,StokKodu)VALUES('" + fistarihi.Text + "','" + fisno.Text + "','" + evrakno.Text + "','" + "1" + "','" + hesapkodu.Text + "','" + "2" + "','" + "3" + "')";
