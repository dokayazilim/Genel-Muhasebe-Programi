...
namespace muhasebe
{
    public partial class Form108 : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'muhasebeDataSet23.hesapkodlari' table. You can move, or remove it, as needed.
            this.hesapkodlariTableAdapter14.Fill(this.muhasebeDataSet23.hesapkodlari);
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            frm2.bitishesapkodu.Text = dataGridView1.Rows[e.RowIndex].Cells[0].Value.ToString();
            this.Hide();
        }
    }
}
