...
namespace muhasebe
{
    public partial class Form6 : Form
    {
        ...
        {
            DialogResult sonuc = MessageBox.Show("Aktif çalışma formundan çıkmak istediğinize emin misiniz?", "Uyarı", MessageBoxButtons.YesNo, MessageBoxIcon.Hand);
        ...
        private void Form6_Load(object sender, EventArgs e)
        {
            ...
            // TODO: This line of code loads data into the 'muhasebeortakhesaplarDataSet2.fisler' table. You can move, or remove it, as needed.
            this.fislerTableAdapter.Fill(this.muhasebeortakhesaplarDataSet2.fisler);
        ...
        {
            /*string col7;
            col7 = dataGridView1[12, dataGridView1.CurrentCell.RowIndex].Value.ToString(); // açıklama...
            ...
            if (eskifislerekaydet.Checked)
            {
                ...
                try
                {
                    ...
                    string komut = "INSERT INTO eskifisler(FisTarihi,FisTipi,FisNo,EvrakNo,BorcToplami,AlacakToplami,Bakiye,Aciklama)VALUES('" + fistarihi.Text + "','" + "Tediye Fişi" + "','" + fisno.Text + "','" + evrakno.Text + "','" + borctoplami.Text + "','" + alacaktoplami.Text + "','" + bakiyetoplami.Text + "','" + col7 + "')";
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        try
                        {
                            ...
                            string komut = "INSERT INTO tediyefisi(FisTarihi,FisNo,EvrakNo,MaddeNo,HesapKodu,FirmaKodu,StokKodu)VALUES('" + fistarihi.Text + "','" + fisno.Text + "','" + evrakno.Text + "','" + "2" + "','" + hesapkodu.Text + "','" + "3" + "','" + "4" + "')";
